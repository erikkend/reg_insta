...
class WebhookRequestHandler(web.View):
    """
    Simple Webhook request handlers for aiohttp web server.
    ...
    But first you need to configure application for getting Dispatcher instance from request handlers!
    ...
    async def post(self):
        ...
        if one of handlers returns instance of :class:`aiogram.dispatcher.webhook.BaseResponse` return it to webhook.
    ...
    def respond_via_request(self, task):
        ...
        warn(f"Detected slow response into webhook. "
             ...
             f"Recommended to use 'async_task' decorator from Dispatcher for handlers with long timeouts.",
             TimeoutWarning)
...
def configure_app(dispatcher, app: web.Application, path=DEFAULT_WEB_PATH, route_name=DEFAULT_ROUTE_NAME):
    """
    You can prepare web.Application for working with webhook handlers.

    :param dispatcher: Dispatcher instance
    :param app: :class:`aiohttp.web.Application`
    :param path: Path to your webhook.
    :param route_name: Name of webhook handlers route
    :return:
    """
