...
class RequestHandler(BaseProtocol):
    ...
    async def _handle_request(
        ...
        try:
            ...
            self.log_debug("Request handlers timed out.", exc_info=exc)
    ...
    async def start(self) -> None:
        ...
        # remove handlers, close transport if no handlers left
    ...
    async def finish_response(
        ...
        try:
            ...
            if resp is None:
                raise RuntimeError("Missing return " "statement on request handlers")
            else:
                raise RuntimeError(
                    "Web-handlers should return "
                    "a response instance, "
                    "got {!r}".format(resp)
                )
        try:
