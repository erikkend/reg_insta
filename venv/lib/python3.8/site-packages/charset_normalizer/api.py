...
def from_bytes(
    ...
    By default the library does not setup any handlers other than the NullHandler, if you choose to set the 'explain'
    toggle to True it will alter the logger configuration to add a StreamHandler that is suitable for debugging.
    Custom logging format and handlers can be set manually.
    """
