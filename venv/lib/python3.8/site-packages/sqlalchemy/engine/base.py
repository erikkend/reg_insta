    ...
    **This is the SQLAlchemy 1.x.x version** of the :class:`_engine.Connection`
    ...
    def execution_options(self, **opt):
        ...
        :param isolation_level: Available on: :class:`_engine.Connection`.
          ...
          where  an event handlers will emit
    ...
    def _invoke_before_exec_event(
        ...
        if event_multiparams:
            ...
            if event_params:
                raise exc.InvalidRequestError(
                    "Event handlers can't return non-empty multiparams "
        ...
        try:
            ...
            if (
                ...
                for fn in self.dispatch.handle_error:
                    try:
                        # handlers returns an exception;
                        # call next handlers in a chain
                        per_fn = fn(ctx)
                        if per_fn is not None:
                            ctx.chained_exception = newraise = per_fn
                    except Exception as _raised:
                        # handlers raises an exception - stop processing
                        newraise = _raised
                        break
...
class Engine(Connectable, log.Identified):
    ...
    def execution_options(self, **opt):
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        An event handlers can consume the above execution option to perform
