...
def create_engine(url, **kwargs):
    ...
    :param echo=False: if True, the Engine will log all statements
        ...
        handlers, which defaults to ``sys.stdout`` for output.   If set to the
    ...
    :param echo_pool=False: if True, the connection pool will log
        ...
        as well as when connections are recycled to the default log handlers,
    ...
    if _initialize:
        ...
        # scaled back if the "on_connect" handlers were present.  now,
