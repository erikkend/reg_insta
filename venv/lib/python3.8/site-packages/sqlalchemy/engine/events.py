...
class ConnectionEvents(event.Events):
    ...
    def handle_error(self, exception_context):
        ...
        * Establishing or disabling whether a connection or the owning
        ...
        .. note::
            ...
            .. [1] The pool "pre_ping" handlers enabled using the
        ...
        A handlers function has two options for replacing
        ...
        .. warning::  Because the
           ...
           **stack traces will be misleading** if the user-defined event
           handlers itself fails and throws an unexpected exception;
        ...
        used, by configuring the handlers with the ``retval=True``
        modifier and returning the new exception instance from the
        function.  In this case, event handling will continue onto the
        next handlers.   The "chained" exception is available using
        ...
        a handlers returns ``None``, the previous exception instance,
    ...
    def set_engine_execution_options(self, engine, opts):
        ...
        event
        handlers to the given :class:`_engine.Engine`
...
class DialectEvents(event.Events):
    ...
    def do_connect(self, dialect, conn_rec, cargs, cparams):
        ...
        This event is useful in that it allows the handlers to manipulate the
    ...
    def do_executemany(self, cursor, statement, parameters, context):
        ...
        place within the event handlers.
