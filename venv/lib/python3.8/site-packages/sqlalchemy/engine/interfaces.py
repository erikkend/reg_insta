...
class ExecutionContext(object):
    ...
    def get_out_parameter_values(self, out_param_names):
        ...
        handlers based on what's present in self.compiled.binds and update the
...
class ExceptionContext(object):
    ...
    """The exception that was returned by the previous handlers in the
    exception chain, if any.

    If present, this exception will be the one ultimately raised by
    SQLAlchemy unless a subsequent handlers replaces it.
    ...
    :meth:`_events.ConnectionEvents.handle_error` handlers.
    ...
    .. note:: The pool "pre_ping" handlers enabled using the
