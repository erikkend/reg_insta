...
A hybrid can define a custom "UPDATE" handlers for when using the
...
hybrid represents more than one column.   We can set up a handlers that will
...
A handlers that works similarly to our setter would be::
