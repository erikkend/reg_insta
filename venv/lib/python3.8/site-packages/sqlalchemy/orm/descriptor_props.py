...
class CompositeProperty(DescriptorProperty):
    ...
    def _setup_event_handlers(self):
        ...
        def _load_refresh_handler(state, context, to_load, is_refresh):
            ...
            # fget() handlers, this already set the value; skip the
            # handlers here. (other handlers like mutablecomposite will still
            # want to catch it)
            # there's an insufficiency here in that the fget() handlers
