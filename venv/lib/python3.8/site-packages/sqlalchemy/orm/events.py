    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    def load(self, target, context):
        ...
        .. warning::
            ...
            if an operation occurs within this event handlers that emits
            ...
            the event handlers include, but are not necessarily limited to:
    ...
    def refresh_flush(self, target, flush_context, attrs):
        ...
        contain a column-level default or onupdate handlers have been refreshed
...
class AttributeEvents(event.Events):
    ...
    def bulk_replace(self, target, values, initiator):
        ...
        :param value: a sequence (e.g. a list) of the values being set.  The
          handlers can modify this list in place.
        :param initiator: An instance of :class:`.attributes.Event`
    ...
    def init_scalar(self, target, value, dict_):
        ...
        event handlers can also be used to **set** the newly returned value, so
        ...
        a handlers might be used as follows::
        ...
        * The ``propagate=True`` flag is significant if the mapped class
        ...
        :param value: the value that is to be returned before this event
         ...
         however will be the return value of the previous event handlers
